...
Hardware acceleration is handled by the VDPAU VA driver, supporting VP9 and h264. All the magic for enabling hardware acceleration is done inside the launch script.
